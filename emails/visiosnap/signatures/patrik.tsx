...
const userImage = `https://profile-next-core.s3.eu-north-1.amazonaws.com/emailing/email-photo_patrik_light.png`
const userName = 'Patrik Vaďura'
const infoEmail = 'hello@visiosnap.cz'
    ...
    <Html>
      ...
      >
        ...
        <Body className="bg-[#F0F1F8] w-full">
          <Container className="bg-white font-sans rounded-xl my-[20px] sm:my-[40px] mx-auto px-[20px] sm:px-[40px] py-[40px] w-full">
            ...
            <Text className="text-left text-black text-[14px] leading-[20px] m-0 p-0">
              ...
              ipsum. Duis viverra diam non justo. Nulla accumsan, elit sit amet varius semper, nulla
